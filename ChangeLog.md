...
* BREAKING: `DecodeError` has a new constructor, `TooLargeInteger`.
* BREAKING: a malformed request reaches a client as `StreamResetIsReceived`
  on the stream it concerns, where it used to arrive as
